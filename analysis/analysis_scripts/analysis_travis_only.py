...
def read_data():
    fs = os.listdir('./output/travis_only')
    ...
    for r in fs:
        ...
        with open(f'./output/travis_only/{r}/anti-patterns.json') as f:
...
def main_travis_only():
    d = read_data()
    print("SLOW BUILD INFO\n============================")
    sb_a, sb_t = slow_build(d, tool='Github Actions')
    print("============================\n\n")
    print("BROKEN RELEASE INFO\n============================")
    br = broken_release(d, tool='Github Actions')
    print("============================\n\n")
